		...
		<div className={index % 2 == 0 ? `${styles.projectView} ${styles.reverse}` : styles.projectView}>
			<div className={styles.info}>
				...
				{(project.repo || project.live) && <div className={styles.links}>
					{project.repo && <a className={styles.repo} href={project.repo}><span className="material-symbols-outlined">Code</span>Repo</a>}
					{project.live && <a className={styles.live} href={project.live}><span className="material-symbols-outlined">Public</span>Live</a>}
				</div>}
			</div>
