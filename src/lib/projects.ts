...
export const projects: Project[] = [{
		...
		name: "VVZ++",
		description: "ETH course browser and study planner. Viscon Hackathon 2025 project.",
		year: "2025",
		status: "In Progress",
		statusIcon: "more_horiz",
		repo: "https://github.com/srpnt3/slopvauzet",
		live: "https://vvz.plus",
		tools: ["TypeScript", "React", "Python"],
		images: ["slopvauzet/1.jpg"],
		contributors: [{
			name: "arbobendik",
			link: "https://github.com/arbobendik",
		}, {
			name: "clorc",
			link: "https://github.com/clorc",
		}, {
			name: "jktham",
			link: "https://github.com/jktham",
		}, {
			name: "KanjiNaem",
			link: "https://github.com/KanjiNaem",
		}, {
			name: "nicabi",
			link: "https://github.com/nicabi",
		}, {
			name: "srpnt3",
			link: "https://github.com/srpnt3",
		}],
